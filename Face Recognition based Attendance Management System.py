...
def contact():
    mess._show(title='Contact us', message="Please contact me on : 'mohammedamanknr@gmail.com' ")
...
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title='Some file missing', message='Please contact email for help')
        window.destroy()
...
# Load and create a PhotoImage
background_image = Image.open("front.jpg")
background_photo = ImageTk.PhotoImage(background_image)

# Create a label and set its image as the PhotoImage object
